...
} from "./chunk-OQBKUXQS.js";
import {
  ButtonGroupContext_default,
  Button_default,
  CircularProgress_default
} from "./chunk-AZNSZWWS.js";
import {
  Tabs_default
} from "./chunk-P4MIKU7I.js";
import {
  InitColorSchemeScript_default,
  ThemeProvider,
  useColorScheme,
  useThemeProps
} from "./chunk-SXXGLOZD.js";
import {
  require_react_dom
...
import {
  ...
  useId_default
} from "./chunk-VQBPYANK.js";
import {
  capitalize_default,
  memoTheme_default
} from "./chunk-PWFUVKPZ.js";
import {
  useDefaultProps
} from "./chunk-HXEFTH3K.js";
import {
  clsx_default,
  createTheme,
  createUnarySpacing,
...
function Notification({
  ...
  const action = (0, import_jsx_runtime2.jsxs)(React5.Fragment, {
...
var Alert_default2 = React6.forwardRef(function DeprecatedAlert(props, ref) {
  warn();
...
var AlertTitle_default2 = React7.forwardRef(function DeprecatedAlertTitle(props, ref) {
  warn2();
...
var Autocomplete_default2 = React8.forwardRef(function DeprecatedAutocomplete(props, ref) {
  warn3();
...
var AvatarGroup_default2 = React9.forwardRef(function DeprecatedAvatarGroup(props, ref) {
  warn4();
...
var CalendarPicker = React10.forwardRef(function DeprecatedCalendarPicker() {
  warn5();
  return null;
});
...
var ClockPicker = React11.forwardRef(function DeprecatedClockPicker() {
  warn6();
  return null;
});
...
var DatePicker = React12.forwardRef(function DeprecatedDatePicker() {
  warn7();
  return null;
});
...
var DateRangePicker = React13.forwardRef(function DeprecatedDateRangePicker() {
  warn8();
  return null;
});
...
var DateRangePickerDay = React14.forwardRef(function DeprecatedDateRangePickerDay() {
  warn9();
  return null;
});
...
var DateTimePicker = React15.forwardRef(function DeprecatedDateTimePicker() {
  warn10();
  return null;
});
...
var DesktopDatePicker = React16.forwardRef(function DeprecatedDesktopDatePicker() {
  warn11();
  return null;
});
...
var DesktopDateRangePicker = React17.forwardRef(function DeprecatedDesktopDateRangePicker() {
  warn12();
  return null;
});
...
var DesktopDateTimePicker = React18.forwardRef(function DeprecatedDesktopDateTimePicker() {
  warn13();
  return null;
});
...
var DesktopTimePicker = React19.forwardRef(function DeprecatedDesktopTimePicker() {
  warn14();
  return null;
});
...
function deepClone(source) {
  if (React20.isValidElement(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React20.isValidElement(source[key])) {
...
var useEnhancedEffect = typeof window !== "undefined" ? React22.useLayoutEffect : React22.useEffect;
...
function useControlled({
  ...
  const [valueState, setValue2] = React24.useState(defaultProp);
...
function useLazyRef(init, initArg) {
  const ref = React26.useRef(UNINITIALIZED);
...
var ClassNameConfiguratorContext = React33.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass3) {
  ...
  } = React33.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React34.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React34.useEffect(() => {
  ...
  const updateRootElementName = React34.useCallback((instance) => {
...
var Badge = React36.forwardRef(function Badge2(props, forwardedRef) {
  const {
    badgeContent: badgeContentProp,
    children,
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React41.useRef(controlledProps);
  if (true) {
    React41.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime11.jsxs)(React44.Fragment, {
...
var FormControlContext = React45.createContext(void 0);
if (true) {
...
var FormControl = React46.forwardRef(function FormControl2(props, forwardedRef) {
  const {
    defaultValue,
    children,
    disabled = false,
...
var Input = React49.forwardRef(function Input2(props, forwardedRef) {
  const {
...
function useTextNavigation(callback) {
  ...
  return React50.useCallback((event) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React51.useCallback((event, value, reason) => {
    var _a;
  ...
  const stateComparers = React51.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React51.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React51.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React51.useMemo(() => ({
  ...
  const previousItems = React51.useRef([]);
  React51.useEffect(() => {
  ...
  const getItemState = React51.useCallback((item) => {
...
var ListContext = React52.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const createHandleClick = React53.useCallback((externalHandlers) => (event) => {
    var _a;
  ...
  const createHandlePointerOver = React53.useCallback((externalHandlers) => (event) => {
    var _a;
...
var CompoundComponentContext = React54.createContext(null);
if (true) {
...
function useCompoundParent() {
  const [subitems, setSubitems] = React54.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React54.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React54.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React54.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React54.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React54.useCallback(function getItemIndex2(id) {
...
function useCompoundItem(id, itemMetadata) {
  const context = React55.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React55.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = React56.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React56.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React56.useMemo(() => Array.from(subitems.keys()), [subitems]);
...
// node_modules/@toolpad/core/node_modules/@mui/lab/node_modules/@mui/base/node_modules/@floating-ui/react-dom/dist/floating-ui.react-dom.mjs
...
function useFloating(options) {
  ...
  const dataRef = React58.useRef(data);
...
var Portal = React59.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(React59.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React59.isValidElement(children)) {
      ...
      return React59.cloneElement(children, newProps);
    }
    return children;
  }
...
var TransitionContext = React60.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React61.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React62.useState(true);
  const hasPendingExitTransition = React62.useRef(false);
  const registeredTransitions = React62.useRef(0);
  const [hasTransition, setHasTransition] = React62.useState(false);
  const previousRequestEnter = React62.useRef(requestEnter);
  React62.useEffect(() => {
  ...
  const registerTransition = React62.useCallback(() => {
...
var PopupContext = React63.createContext(null);
if (true) {
...
var Popup = React64.forwardRef(function Popup2(props, forwardedRef) {
  const {
    anchor: anchorProp,
    children,
    container,
  ...
  const popupContextValue = React64.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React65.forwardRef(function Menu2(props, forwardedRef) {
  const {
    actions,
    anchor: anchorProp,
    children,
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React66.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React67.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    label,
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = React68.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  const listContext = React69.useContext(ListContext);
  if (!listContext) {
  ...
  const localGetItemState = React69.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React69.useMemo(() => ({
    dispatch,
...
var InnerMenuItem = React70.memo(React70.forwardRef(function MenuItem(props, forwardedRef) {
  const {
    children,
    disabled: disabledProp = false,
    label,
...
var MenuItem2 = React70.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useModal(parameters) {
  ...
  const isTopModal = React71.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var Modal = React72.forwardRef(function Modal2(props, forwardedRef) {
  const {
    children,
    closeAfterTransition = false,
    container,
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React74.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React74.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React74.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React75.forwardRef(function NumberInput2(props, forwardedRef) {
  const {
    className,
    defaultValue,
    disabled,
...
var OptionGroup = React76.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {},
...
function useOption(params) {
  ...
  const selectOption = React77.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  const listContext = React78.useContext(ListContext);
  if (!listContext) {
  ...
  const localGetItemState = React78.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React78.useMemo(() => ({
    dispatch,
    getItemState: localGetItemState
  }), [dispatch, localGetItemState]);
  return {
...
var InnerOption = React79.forwardRef(function InnerOption2(props, forwardedRef) {
  var _a, _b;
  const {
    children,
    disabled = false,
...
var InnerOptionMemo = React79.memo(InnerOption);
var Option = React79.forwardRef(function Option2(props, ref) {
  const {
    value
  } = props;
  const {
...
var PopperTooltip = React80.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const tooltipRef = React80.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React80.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React80.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React80.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React80.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React80.useState(resolveAnchorEl(anchorEl));
  React80.useEffect(() => {
...
var Popper = React80.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function useSelect(props) {
  ...
  const optionValues = React81.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React81.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React81.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    return (option == null ? void 0 : option.disabled) ?? false;
  }, [getOptionByValue]);
  const stringifyOption = React81.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React81.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React81.useCallback((itemValue) => {
    var _a;
    return (_a = options.get(itemValue)) == null ? void 0 : _a.id;
  }, [options]);
  const handleSelectionChange = React81.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React81.useCallback((event, newValue) => {
    onHighlightChange == null ? void 0 : onHighlightChange(event, newValue ?? null);
  }, [onHighlightChange]);
  const handleStateChange = React81.useCallback((event, field, fieldValue) => {
    var _a;
    if (field === "open") {
  ...
  const getItemDomElement = React81.useCallback((itemId) => {
    var _a;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React81.useRef(open);
  useEnhancedEffect_default(() => {
    var _a;
  ...
  const getOptionMetadata = React81.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime25.jsx)(React83.Fragment, {
...
var Select = React83.forwardRef(function Select2(props, forwardedRef) {
  const {
    areOptionsEqual,
    autoComplete,
    autoFocus,
  ...
  const [buttonDefined, setButtonDefined] = React83.useState(false);
  const buttonRef = React83.useRef(null);
  const listboxRef = React83.useRef(null);
  const Button3 = slots.root ?? "button";
  const ListboxRoot = slots.listbox ?? "ul";
  const PopupComponent = slots.popup ?? "div";
  const handleButtonRefChange = React83.useCallback((element) => {
  ...
  return (0, import_jsx_runtime25.jsxs)(React83.Fragment, {
...
var Slider = React85.forwardRef(function Slider2(props, forwardedRef) {
  const {
    "aria-label": ariaLabel,
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime26.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime26.jsxs)(React85.Fragment, {
...
var Snackbar = React87.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React89.forwardRef(function Switch2(props, forwardedRef) {
  const {
    checked: checkedProp,
    defaultChecked,
    disabled: disabledProp,
...
var TablePaginationActions = React90.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  const {
    count,
...
var TablePagination = React91.forwardRef(function TablePagination2(props, forwardedRef) {
  const {
    colSpan: colSpanProp,
    count,
...
function useTabs(parameters) {
  ...
  const onSelected = React92.useCallback((event, newValue) => {
    setValue2(newValue);
  ...
  const tabIdLookup = React92.useRef(() => void 0);
  const getTabPanelId = React92.useCallback((tabValue) => {
    var _a;
    return (_a = tabPanels.get(tabValue)) == null ? void 0 : _a.id;
  }, [tabPanels]);
  const getTabId2 = React92.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React92.useCallback((lookupFunction) => {
...
var TabsContext = React93.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React93.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const compoundComponentContextValue = React94.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
  const tabsContextValue = React94.useMemo(() => ({
    direction,
    getTabId: getTabId2,
    getTabPanelId,
    onSelected,
...
var Tabs = React95.forwardRef(function Tabs2(props, forwardedRef) {
  const {
    children,
    value: valueProp,
    defaultValue,
...
function useTabPanel(parameters) {
  ...
  const metadata = React96.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React97.forwardRef(function TabPanel2(props, forwardedRef) {
  const {
    children,
    value,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React98.useCallback((tabValue) => {
    var _a;
    return (_a = subitems.get(tabValue)) == null ? void 0 : _a.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React98.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React98.useCallback((tabValue) => {
    var _a;
    if (tabValue == null) {
      return null;
    }
  ...
  const handleChange = React98.useCallback((event, newValue) => {
    onSelected(event, newValue[0] ?? null);
  }, [onSelected]);
  const controlledProps = React98.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React98.useCallback((item) => {
    var _a;
  ...
  const {
    ...
    reducerActionContext: React98.useMemo(() => ({
...
function TabsListProvider(props) {
  ...
  const listContextValue = React99.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React99.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
...
var TabsList = React100.forwardRef(function TabsList2(props, forwardedRef) {
  const {
    children,
    slotProps = {},
    slots = {},
...
function useTab(parameters) {
  ...
  const tabRef = React101.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React101.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React102.forwardRef(function Tab2(props, forwardedRef) {
  const {
    action,
    children,
    disabled = false,
...
var TextareaAutosize = React103.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React103.useRef(null);
  const shadowRef = React103.useRef(null);
  const calculateTextareaStyles = React103.useCallback(() => {
  ...
  const syncHeight = React103.useCallback(() => {
  ...
  return (0, import_jsx_runtime37.jsxs)(React103.Fragment, {
...
var LoadingButton = React107.forwardRef(function LoadingButton2(inProps, ref) {
  const contextProps = React107.useContext(ButtonGroupContext_default);
...
var LocalizationProvider = React108.forwardRef(function DeprecatedLocalizationProvider() {
  warn15();
  return null;
});
...
var MobileDatePicker = React109.forwardRef(function DeprecatedMobileDatePicker(props, ref) {
  warn16();
  return null;
});
...
var MobileDateRangePicker = React110.forwardRef(function DeprecatedMobileDateRangePicker() {
  warn17();
  return null;
});
...
var MobileDateTimePicker = React111.forwardRef(function DeprecatedMobileDateTimePicker() {
  warn18();
  return null;
});
...
var MobileTimePicker = React112.forwardRef(function DeprecatedMobileTimePicker() {
  warn19();
  return null;
});
...
var MonthPicker = React113.forwardRef(function DeprecatedMonthPicker() {
  warn20();
  return null;
});
...
var Pagination_default2 = React114.forwardRef(function DeprecatedPagination(props, ref) {
  warn21();
...
var PaginationItem_default2 = React115.forwardRef(function DeprecatedPaginationItem(props, ref) {
  warn22();
...
var CalendarPickerSkeleton = React116.forwardRef(function DeprecatedCalendarPickerSkeleton() {
  warn23();
  return null;
});
...
var PickersDay = React117.forwardRef(function DeprecatedPickersDay() {
  warn24();
  return null;
});
...
var Rating_default2 = React118.forwardRef(function DeprecatedRating(props, ref) {
  warn25();
...
var Skeleton_default2 = React119.forwardRef(function DeprecatedSkeleton(props, ref) {
  warn26();
...
var SpeedDial_default2 = React120.forwardRef(function DeprecatedSpeedDial(props, ref) {
  warn27();
...
var SpeedDialAction_default2 = React121.forwardRef(function DeprecatedSpeedDialAction(props, ref) {
  warn28();
...
var SpeedDialIcon_default2 = React122.forwardRef(function DeprecatedSpeedDialIcon(props, ref) {
  warn29();
...
var StaticDatePicker = React123.forwardRef(function DeprecatedStaticDatePicker() {
  warn30();
  return null;
});
...
var StaticDateRangePicker = React124.forwardRef(function DeprecatedStaticDateRangePicker() {
  warn31();
  return null;
});
...
var StaticDateTimePicker = React125.forwardRef(function DeprecatedStaticDateTimePicker() {
  warn32();
  return null;
});
...
var StaticTimePicker = React126.forwardRef(function DeprecatedStaticTimePicker() {
  warn33();
  return null;
});
...
var Context = React127.createContext(null);
if (true) {
  Context.displayName = "TabContext";
}
function useUniquePrefix() {
  const [id, setId] = React127.useState(null);
  React127.useEffect(() => {
...
function useTabContext() {
  return React127.useContext(Context);
}
...
var TabList = React128.forwardRef(function TabList2(props, ref) {
  const {
...
var TabPanel3 = React129.forwardRef(function TabPanel4(inProps, ref) {
...
var TimePicker = React130.forwardRef(function DeprecatedTimePicker() {
  warn34();
  return null;
});
...
var TimelineContext = React131.createContext({});
if (true) {
...
var Timeline = React132.forwardRef(function Timeline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeline"
  });
...
var TimelineConnector = React133.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
...
var TimelineContent = React134.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
...
var TimelineDot = React135.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
...
var TimelineOppositeContent = React136.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
  ...
  const {
    position: positionContext
  } = React136.useContext(TimelineContext_default);
  const ownerState = {
    ...props,
...
var TimelineItem = React137.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  const {
    position: positionContext
  } = React137.useContext(TimelineContext_default);
  let hasOppositeContent = false;
  React137.Children.forEach(props.children, (child) => {
...
var TimelineSeparator = React138.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
...
var ToggleButton_default2 = React139.forwardRef(function DeprecatedToggleButton(props, ref) {
  warn35();
...
var ToggleButtonGroup_default2 = React140.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  warn36();
...
var TreeItem = React141.forwardRef(function DeprecatedTreeItem() {
  warn37();
  return null;
});
...
var TreeView = React142.forwardRef(function DeprecatedTreeView() {
  warn38();
  return null;
});
...
var Masonry = React143.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React143.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React143.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React143.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = {
    ...props,
    spacing,
    columns,
  ...
  const handleResize = React143.useCallback((masonryChildren) => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index2) => (0, import_jsx_runtime60.jsx)("span", {
...
var DialogsContext = React144.createContext(null);
...
function DialogsProvider(props) {
  ...
  const [stack, setStack] = React146.useState([]);
  const keyPrefix = React146.useId();
  const nextId2 = React146.useRef(0);
  const requestDialog = React146.useCallback(function open(Component, payload, options = {}) {
    const {
      onClose = async () => {
      }
    } = options;
  ...
  const closeDialogUi = React146.useCallback(function closeDialogUi2(dialog) {
  ...
  const closeDialog = React146.useCallback(async function closeDialog2(dialog, result) {
...
var BrandingContext = React147.createContext(null);
var NavigationContext = React147.createContext([]);
var PaletteModeContext = React147.createContext({
  paletteMode: "light",
  setPaletteMode: () => {
  },
  isDualTheme: false
});
var RouterContext = React147.createContext(null);
var WindowContext = React147.createContext(void 0);
...
function useStorageState(area, key, initializer = null, options) {
  ...
  const [initialValue] = React148.useState(initializer);
  const encodedInitialValue = React148.useMemo(() => encode(codec, initialValue), [codec, initialValue]);
  const subscribeKey = React148.useCallback((callback) => subscribe(area, key, callback), [area, key]);
  const getKeySnapshot = React148.useCallback(() => getSnapshot(area, key) ?? encodedInitialValue, [area, encodedInitialValue, key]);
  const encodedStoredValue = React148.useSyncExternalStore(subscribeKey, getKeySnapshot, getKeyServerSnapshot);
  const storedValue = React148.useMemo(() => decode(codec, encodedStoredValue), [codec, encodedStoredValue]);
  const setStoredValue = React148.useCallback((value) => {
  ...
  const [nonStoredValue, setNonStoredValue] = React148.useState(initialValue);
  if (!key) {
...
function LegacyThemeProvider(props) {
  ...
  const dualAwareTheme = React149.useMemo(() => isDualTheme ? theme[paletteMode === "dark" ? "dark" : "light"] ?? theme[paletteMode === "dark" ? "light" : "dark"] : theme, [isDualTheme, paletteMode, theme]);
  const paletteModeContextValue = React149.useMemo(() => ({
    paletteMode,
...
var AuthenticationContext = React150.createContext(null);
var SessionContext = React150.createContext(null);
...
@mui/lab/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Z66FRAG2.js.map
