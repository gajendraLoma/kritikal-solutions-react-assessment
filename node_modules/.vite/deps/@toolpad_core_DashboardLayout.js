...
} from "./chunk-7VACUGSW.js";
import {
  IconButton_default
} from "./chunk-QLVV6H24.js";
import {
  Button_default
} from "./chunk-SDT23NVQ.js";
import "./chunk-US7SB5JB.js";
import {
  Stack_default
} from "./chunk-FDN3FM3M.js";
import "./chunk-MDPHU4RB.js";
import "./chunk-ZA4R63NH.js";
import "./chunk-YEJSXIVD.js";
import "./chunk-UM7JPEGG.js";
import "./chunk-UVKBGNIT.js";
import "./chunk-KDCVS43I.js";
import {
  createSvgIcon
} from "./chunk-5KFYOLSL.js";
import "./chunk-MA2OEK3Z.js";
import "./chunk-UM6KWBIP.js";
import "./chunk-3TP3HPF6.js";
import {
  Box_default
} from "./chunk-IBTVWWJ4.js";
import "./chunk-ZSFTTG5S.js";
import {
  useTheme
} from "./chunk-JBAVKE3V.js";
import {
  styled_default
} from "./chunk-NXJAABTT.js";
import {
  require_jsx_runtime
...
function DashboardSidebarSubNavigation({
  ...
  return (0, import_jsx_runtime15.jsx)(List_default, {
    ...
    children: subNavigation.map((navigationItem, navigationItemIndex) => {
      ...
      return (0, import_jsx_runtime15.jsxs)(React9.Fragment, {
...
var DarkMode_default = createSvgIcon((0, import_jsx_runtime16.jsx)("path", {
...
var LightMode_default = createSvgIcon((0, import_jsx_runtime17.jsx)("path", {
...
function ThemeSwitcher() {
  ...
  return isDualTheme ? (0, import_jsx_runtime18.jsx)(Tooltip_default, {
    ...
    children: (0, import_jsx_runtime18.jsx)("div", {
      children: (0, import_jsx_runtime18.jsx)(IconButton_default, {
        ...
        children: theme.getColorSchemeSelector ? (0, import_jsx_runtime18.jsxs)(React11.Fragment, {
          children: [(0, import_jsx_runtime18.jsx)(DarkMode_default, {
            sx: {
              display: "inline",
          ...
          }), (0, import_jsx_runtime18.jsx)(LightMode_default, {
            sx: {
              display: "none",
              [theme.getColorSchemeSelector("dark")]: {
                display: "inline"
        ...
        }) : (0, import_jsx_runtime18.jsx)(React11.Fragment, {
          children: isSsr || paletteMode !== "dark" ? _DarkModeIcon || (_DarkModeIcon = (0, import_jsx_runtime18.jsx)(DarkMode_default, {})) : _LightModeIcon || (_LightModeIcon = (0, import_jsx_runtime18.jsx)(LightMode_default, {}))
        })
      })
    })
  }) : null;
...
function ToolbarActions() {
  return _Stack || (_Stack = (0, import_jsx_runtime19.jsx)(Stack_default, {
    direction: "row",
    alignItems: "center",
    children: (0, import_jsx_runtime19.jsx)(ThemeSwitcher, {})
  }));
}
...
function ToolpadLogo({
  ...
  return (0, import_jsx_runtime20.jsxs)("svg", {
    width: size,
    height: size,
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    children: [_g || (_g = (0, import_jsx_runtime20.jsxs)("g", {
      mask: "url(#a)",
    ...
    })), (0, import_jsx_runtime20.jsx)("mask", {
      id: "b",
      style: {
        maskType: "alpha"
      },
      ...
      width: "14",
      height: "15",
      children: _path || (_path = (0, import_jsx_runtime20.jsx)("path", {
    ...
    }), _g2 || (_g2 = (0, import_jsx_runtime20.jsxs)("g", {
      mask: "url(#b)",
      children: [(0, import_jsx_runtime20.jsx)("path", {
      ...
      width: "22",
      height: "20",
      children: _path2 || (_path2 = (0, import_jsx_runtime20.jsx)("path", {
    ...
    }), _g3 || (_g3 = (0, import_jsx_runtime20.jsxs)("g", {
      mask: "url(#c)",
      children: [(0, import_jsx_runtime20.jsx)("path", {
...
function useApplicationTitle() {
  const branding = React14.useContext(BrandingContext);
...
function AppTitle(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(Link, {
    ...
    children: (0, import_jsx_runtime21.jsxs)(Stack_default, {
      direction: "row",
      alignItems: "center",
      children: [(0, import_jsx_runtime21.jsx)(LogoContainer, {
        children: ((_c = props == null ? void 0 : props.branding) == null ? void 0 : _c.logo) ?? (_ToolpadLogo || (_ToolpadLogo = (0, import_jsx_runtime21.jsx)(ToolpadLogo, {
          size: 40
        })))
      }), (0, import_jsx_runtime21.jsx)(Typography_default, {
        variant: "h6",
        sx: {
...
function DashboardLayout(props) {
  ...
  const setIsNavigationExpanded = React16.useCallback((newExpanded) => {
    if (isOverMdViewport) {
  ...
  const selectedItemIdRef = React16.useRef("");
  const handleSetNavigationExpanded = React16.useCallback((newExpanded) => () => {
    setIsNavigationExpanded(newExpanded);
  }, [setIsNavigationExpanded]);
  const toggleNavigationExpanded = React16.useCallback(() => {
  ...
  const getMenuIcon = React16.useCallback((isExpanded) => {
    const expandMenuActionText = "Expand";
    const collapseMenuActionText = "Collapse";
    return (0, import_jsx_runtime22.jsx)(Tooltip_default, {
      title: `${isExpanded ? collapseMenuActionText : expandMenuActionText} menu`,
      enterDelay: 1e3,
      children: (0, import_jsx_runtime22.jsx)("div", {
        children: (0, import_jsx_runtime22.jsx)(IconButton_default, {
          "aria-label": `${isExpanded ? collapseMenuActionText : expandMenuActionText} navigation menu`,
          onClick: toggleNavigationExpanded,
          children: isExpanded ? _MenuOpenIcon || (_MenuOpenIcon = (0, import_jsx_runtime22.jsx)(MenuOpen_default, {})) : _MenuIcon || (_MenuIcon = (0, import_jsx_runtime22.jsx)(Menu_default, {}))
        })
      })
    });
  ...
  const getDrawerContent = React16.useCallback((isMini, viewport) => {
    var _a;
    return (0, import_jsx_runtime22.jsxs)(React16.Fragment, {
      children: [_Toolbar || (_Toolbar = (0, import_jsx_runtime22.jsx)(Toolbar_default, {})), (0, import_jsx_runtime22.jsxs)(Box_default, {
        component: "nav",
        ...
        children: [(0, import_jsx_runtime22.jsx)(DashboardSidebarSubNavigation, {
        ...
        }), SidebarFooterSlot ? (0, import_jsx_runtime22.jsx)(SidebarFooterSlot, {
          mini: isMini,
  ...
  const getDrawerSharedSx = React16.useCallback((isMini, isTemporary) => {
  ...
  const layoutRef = React16.useRef(null);
  return (0, import_jsx_runtime22.jsxs)(Box_default, {
    ref: layoutRef,
    sx: {
      position: "relative",
      display: "flex",
    ...
    children: [(0, import_jsx_runtime22.jsx)(AppBar, {
      color: "inherit",
      position: "absolute",
      sx: {
        displayPrint: "none"
      },
      children: (0, import_jsx_runtime22.jsx)(Toolbar_default, {
        sx: {
        ...
        children: (0, import_jsx_runtime22.jsxs)(Stack_default, {
          direction: "row",
          justifyContent: "space-between",
          alignItems: "center",
          sx: {
          ...
          children: [(0, import_jsx_runtime22.jsxs)(Stack_default, {
            direction: "row",
            children: [!hideNavigation ? (0, import_jsx_runtime22.jsxs)(React16.Fragment, {
              children: [(0, import_jsx_runtime22.jsx)(Box_default, {
                sx: {
                  mr: {
              ...
              }), (0, import_jsx_runtime22.jsx)(Box_default, {
                sx: {
                  display: {
                    xs: "none",
            ...
            }) : null, (slots == null ? void 0 : slots.appTitle) ? (0, import_jsx_runtime22.jsx)(slots.appTitle, {
          ...
          }), (0, import_jsx_runtime22.jsxs)(Stack_default, {
            direction: "row",
            alignItems: "center",
            spacing: 1,
            sx: {
            ...
            children: [(0, import_jsx_runtime22.jsx)(ToolbarActionsSlot, {
              ...slotProps == null ? void 0 : slotProps.toolbarActions
            }), (0, import_jsx_runtime22.jsx)(ToolbarAccountSlot, {
              ...slotProps == null ? void 0 : slotProps.toolbarAccount
            })]
          })]
        })
      })
    }), !hideNavigation ? (0, import_jsx_runtime22.jsxs)(React16.Fragment, {
      children: [(0, import_jsx_runtime22.jsx)(Drawer_default, {
      ...
      }), (0, import_jsx_runtime22.jsx)(Drawer_default, {
        variant: "permanent",
        sx: {
          display: {
            xs: "none",
    ...
    }) : null, (0, import_jsx_runtime22.jsxs)(Box_default, {
      sx: {
        display: "flex",
        flexDirection: "column",
        flex: 1,
